...
public class HistoryDetailsServlet extends HttpServlet {
    private final String detailsPage = "historyDetailsPage";
    private final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(HistoryDetailsServlet.class.getName());
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            detailsDAO.getDetailsTest(id);
            List<TblDetailsTestDTO> list = detailsDAO.getList();
